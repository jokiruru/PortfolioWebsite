...
var colours = new Array(\
    "#ff77b8", // Soft pink (main color)\
    "#f9a8d4", // Lighter pink (for contrast)\
    "#d6a2e8", // Soft lavender/purple\
    "#a7d8e6", // Light blue/teal (adds iridescence)\
    "#e1e1e1"  // Soft white/gray (to balance out the hues)\
);\
